...
_SPECS: tuple[LibrarySpec, ...] = (
    ...
    LibrarySpec(
        ...
        size_class="online",
        source=Source(
            api_base="https://gnomad.broadinstitute.org/api",
            urls=("https://gnomad.broadinstitute.org/",),
        ),
    ...
    LibrarySpec(
        id="gwas-catalog",
        title="GWAS Catalog (live REST API)",
        helps="fetches GWAS Catalog trait association records and source gene fields for public variant and gene evidence",
        kind=Kind.ONLINE,
        size_class="online",
        source=Source(
            api_base="https://www.ebi.ac.uk/gwas/rest/api/v2",
            urls=(
    ...
    LibrarySpec(
        ...
        helps="fetches Open Targets trait-gene and disease drug-target records for public candidate-gene evidence",
        kind=Kind.ONLINE,
        size_class="online",
        source=Source(
            api_base="https://api.platform.opentargets.org/api/v4/graphql",
            urls=("https://platform.opentargets.org/",),
        ),
        freshness=Freshness.LIVE,
    ),
    LibrarySpec(
        id="ncbi-geo",
        title="NCBI GEO DataSets E-Utilities and FTP",
        helps="discovers public GEO perturbation studies and bounded table downloads for functional genomics grounding",
        kind=Kind.ONLINE,
        size_class="online",
        source=Source(
    ...
    LibrarySpec(
        id="quickgo",
        title="QuickGO Gene Ontology Annotation (live REST API)",
        helps="fetches GO term metadata and gene annotations for controlled analytical grounding",
        kind=Kind.ONLINE,
        size_class="online",
        source=Source(
            api_base="https://www.ebi.ac.uk/QuickGO/services",
            urls=("https://www.ebi.ac.uk/QuickGO/api/index.html",),
        ),
        freshness=Freshness.LIVE,
    ),
    LibrarySpec(
        id="reactome",
        title="Reactome ContentService (live REST API)",
        helps="fetches Reactome pathway records and participant genes for analytical grounding",
        kind=Kind.ONLINE,
        size_class="online",
        source=Source(
            api_base="https://reactome.org/ContentService",
            urls=("https://reactome.org/ContentService/",),
        ),
        freshness=Freshness.LIVE,
    ),
    LibrarySpec(
        id="kegg",
        title="KEGG REST API",
        helps="fetches KEGG pathway, compound, enzyme, and human gene links for analytical grounding",
        kind=Kind.ONLINE,
        size_class="online",
        source=Source(
            api_base="https://rest.kegg.jp",
            urls=("https://www.kegg.jp/kegg/rest/keggapi.html",),
        ),
        freshness=Freshness.LIVE,
    ),
    LibrarySpec(
        id="hpa",
        title="Human Protein Atlas API and TSV downloads",
        helps="fetches HPA tissue and single-cell RNA specificity records for analytical grounding",
        kind=Kind.ONLINE,
        size_class="online",
        source=Source(
            api_base="https://www.proteinatlas.org/api",
            urls=("https://www.proteinatlas.org/download/tsv",),
        ),
        freshness=Freshness.LIVE,
    ),
    LibrarySpec(
        ...
        source=Source(
            ...
            urls=("https://www.ebi.ac.uk/chembl/api/data/docs",),
        ),
        freshness=Freshness.LIVE,
    ),
    LibrarySpec(
        id="biogrid-orcs",
        title="BioGRID ORCS (live REST API)",
        helps="fetches public BioGRID ORCS perturbation screen and score records for functional genomics grounding",
        kind=Kind.ONLINE,
        size_class="online",
        source=Source(
            api_base="https://orcsws.thebiogrid.org",
            urls=("https://orcs.thebiogrid.org/",),
        ),
        freshness=Freshness.LIVE,
    ),
    LibrarySpec(
        id="depmap",
        title="DepMap public screen downloads",
        helps="describes public DepMap CRISPR gene effect release tables used for functional genomics grounding",
        kind=Kind.ONLINE,
        size_class="online",
        source=Source(
            api_base="https://depmap.org/portal/download/all/",
            urls=("https://depmap.org/portal/download/all/",),
        ),
        freshness=Freshness.LIVE,
    ),
    LibrarySpec(
