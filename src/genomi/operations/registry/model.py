...
_DISPLAY_TITLE_OVERRIDES: dict[str, str] = {
    ...
    "active_genome_index.clear_selection": "Using Genomi to clear the active context",
    "active_genome_index.approve_access": "Using Genomi to approve Active Genome Index access",
    "active_genome_index.revoke_access": "Using Genomi to revoke Active Genome Index access",
