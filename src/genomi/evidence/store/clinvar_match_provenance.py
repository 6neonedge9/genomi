...
from ...clinvar_match_model import (
    MATCH_BASIS_CONSUMER_ARRAY_ALLELE_INFERENCE as MATCH_BASIS_CONSUMER_ARRAY_ALLELE_INFERENCE,
    MATCH_BASIS_EXACT_ALLELE as MATCH_BASIS_EXACT_ALLELE,
    MATCH_BASIS_LIFTOVER_EXACT_ALLELE as MATCH_BASIS_LIFTOVER_EXACT_ALLELE,
    MATCH_BASIS_LIFTOVER_MULTIALLELIC_ALT as MATCH_BASIS_LIFTOVER_MULTIALLELIC_ALT,
    MATCH_BASIS_MULTIALLELIC_ALT as MATCH_BASIS_MULTIALLELIC_ALT,
    MATCH_BASIS_VALUES as MATCH_BASIS_VALUES,
